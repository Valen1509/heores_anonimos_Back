...
const crear = (proyecto) => {
    ...
    db.query('INSERT INTO proyecto SET ?',{idProyecto:proyecto.idProyecto, nombreHeroe:proyecto.nombreHeroe, profesionHeroe:proyecto.profesionHeroe, autor:proyecto.autor, descripcion:proyecto.descripcion, imgProyecto:proyecto.imgProyecto}, (err, results) => {
